...
class Test_media_photos:
    ...
    ".querySelector('x-toolbar-button[label=\"Media\"]');"
        ...
        self.driver.save_screenshot(".\\Screenshots\\test_04_media_photos.png")
# videos
        self.media_videos = self.driver.execute_script(
    "return document.querySelector('x-app[dir=\"ltr\"]').shadowRoot"
    ".querySelector('x-editor[dir=\"ltr\"]').shadowRoot"
    ".querySelector('hz-inspire-panel-media[class=\"assets-section\"]').shadowRoot"
    ".querySelector('sp-tab[id=\"sp-tab-4\"]').shadowRoot"
    ".querySelector('label[id=\"item-label\"]');"
        )   
        self.driver.execute_script("arguments[0].click();", self.media_videos)
        time.sleep(3)
        self.driver.save_screenshot(".\\Screenshots\\test_04_media_videos.png")

#audio
        self.media_audio = self.driver.execute_script(
    "return document.querySelector('x-app[dir=\"ltr\"]').shadowRoot"
    ".querySelector('x-editor[dir=\"ltr\"]').shadowRoot"
    ".querySelector('hz-inspire-panel-media[class=\"assets-section\"]').shadowRoot"
    ".querySelector('sp-tab[id=\"sp-tab-5\"]').shadowRoot"
    ".querySelector('label[id=\"item-label\"]');"
        )   
        self.driver.execute_script("arguments[0].click();", self.media_audio)
        time.sleep(3)
        self.driver.save_screenshot(".\\Screenshots\\test_04_media_audio.png")
